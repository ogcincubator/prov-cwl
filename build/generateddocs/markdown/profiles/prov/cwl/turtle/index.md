...
# CWL (Prov) from Turtle (Model)

`ogc.profiles.prov.cwl.turtle` *v0.1*
...
### Example output from revsort-1 run
Obtained from https://github.com/common-workflow-language/cwlprov/
#### turtle
```turtle
