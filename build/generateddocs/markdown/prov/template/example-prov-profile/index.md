...
[] dct:type "Entity",
    ...
    prov:qualifiedGeneration [ dct:type "Generation" ;
            prov:activity [ rdfs:label "Run of workflow/packed.cwl#main/sorted" ;
                    dct:type "Activity",
                        "wfprov:ProcessRun" ;
                    prov:qualifiedAssociation [ dct:type "Association" ;
                            prov:hadPlan [ dct:type "Entity",
                                        "Plan",
                                        "wfdesc:Process" ] ] ;
                    prov:qualifiedEnd [ dct:type "End" ;
                            prov:atTime "2018-10-25T15:46:38.069110"^^xsd:dateTime ;
                            prov:hadActivity [ rdfs:label "Run of workflow/packed.cwl#main" ;
                                    dct:type "Activity",
                                        "wfprov:WorkflowRun" ;
                                    prov:qualifiedAssociation [ dct:type "Association" ;
                                            prov:hadPlan [ rdfs:label "Prospective provenance" ;
                                                    dct:type "Entity",
                                                        "Plan",
                                                        "wfdesc:Workflow" ;
                                                    wfdesc:hasSubProcess [ dct:type "Entity",
                                                                "Plan",
                                                                "wfdesc:Process" ],
                                                        [ ] ] ] ;
                                    prov:qualifiedEnd [ dct:type "End" ;
                                            prov:atTime "2018-10-25T15:46:43.020168"^^xsd:dateTime ;
                                            prov:hadActivity [ rdfs:label "cwltool 1.0.20181012180214" ;
                                                    dct:type "Agent",
                                                        "SoftwareAgent",
                                                        "wfprov:WorkflowEngine" ;
                                                    prov:qualifiedStart [ dct:type "Start" ;
                                                            prov:atTime "2018-10-25T15:46:35.210973"^^xsd:dateTime ;
                                                            prov:hadActivity [ dct:type "Agent" ;
                                                                    prov:actedOnBehalfOf [ rdfs:label "Stian Soiland-Reyes" ;
                                                                            dct:type "Agent",
                                                                                "Person",
                                                                                "schemaorg:Person" ;
                                                                            schemaorg:name "Stian Soiland-Reyes" ;
                                    ...
                                    prov:qualifiedUsage [ dct:type "Usage" ;
                                        ...
                                        [ dct:type "Usage" ;
                                            ...
                                            prov:entity [ dct:type "Entity",
                                                        "wf4ever:File",
                                                        "wfprov:Artifact" ;
                                                    prov:specializationOf [ dct:type "Entity",
                                                                "wfprov:Artifact" ] ;
                                                    cwlprov:basename "whale.txt" ;
                                                    cwlprov:nameext ".txt" ;
                                                    cwlprov:nameroot "whale" ] ] ;
                    ...
                    prov:qualifiedUsage [ dct:type "Usage" ;
                        ...
                        [ dct:type "Usage" ;
                            ...
                            prov:entity [ dct:type "Entity",
                                        ...
                                        "wfprov:Artifact" ;
                                    prov:qualifiedGeneration [ dct:type "Generation" ;
                                            prov:activity [ rdfs:label "Run of workflow/packed.cwl#main/rev" ;
                                                    dct:type "Activity",
                                                        "wfprov:ProcessRun" ;
                                                    prov:qualifiedAssociation [ dct:type "Association" ;
                                                    ...
                                                    prov:qualifiedUsage [ dct:type "Usage" ;
                                                            ...
                                                            prov:entity [ dct:type "Entity",
                                                                    ...
                                                                    cwlprov:nameext ".txt" ;
                                                                    cwlprov:nameroot "whale" ] ] ;
                                                    prov:wasAssociatedWith [ rdfs:label "Container execution of image debian:8" ;
                                                            dct:type "Agent",
                                                                "SoftwareAgent" ;
                                                            cwlprov:image "debian:8" ],
                                                        uuid:ac9c1653-4291-47bc-86f8-6dedcff13519 ] ;
